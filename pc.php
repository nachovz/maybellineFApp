...
<meta property="og:url" content="http://geekies.co/maybelline/pc.php?url=<?php echo $_REQUEST["url"];?>" />
...
<div class="container">
        ...
        <div class="s-cellimagen111"><img src="imagen/compu_11.png" width="110" height="51" class="menu" hover="imagen/compu_11.png"></div>
        </div>
        ...
        <div class="s-cellimagen2"><img src="imagen/cel_11.png" width="60" height="51" class="menu" hover="imagen/cel_1.png"></div>
        </div>
        ...
        <div class="contImgPC"><img src="<?php echo $_REQUEST["url"];?>" width="384" height="401"></div>
      <div class="conIpad"><img src="imagen/pcfull.png" width="423" height="370"></div>
      <div class="conPCPantalla"><img src="<?php echo $_REQUEST["url"];?>" width="166" height="221"></div>
 <div class="conPC"><img src="imagen/ipadfull.png" width="204" height="538"></div>
            <div class="menucell">
            <div><img src="imagen/descarga.png" width="83" height="15"></div>
            <ul class="s-menucell">
            <li><img src="imagen/1024 x 768.png" width="177" height="73" class="menu" hover="imagen/1024 x 7681.png" onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=<?php echo $nombre_imagen;?>_1024_768.<?php echo $tipo_imagen;?>'"></li>
            <li class="s-menucell1"><img src="imagen/1280 x 1024.png" width="177" height="73" hover="imagen/1280 x 10241.png" class="menu"  onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=<?php echo $nombre_imagen;?>_1280_1024.<?php echo $tipo_imagen;?>'"></li>
            <li class="s-menucell1"><img src="imagen/1680 x 1050.png" width="177" height="73" hover="imagen/1680 x 10501.png" class="menu"  onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=<?php echo $nombre_imagen;?>_1680_1050.<?php echo $tipo_imagen;?>'"></li>
            <li class="s-menucell1"><img src="imagen/2560 x 1440.png" width="177" height="73" hover="imagen/2560 x 14401.png" class="menu"  onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=<?php echo $nombre_imagen;?>_2560_1440.<?php echo $tipo_imagen;?>'"></li>
            </ul>
         	<div class="SocialDiv">
<div class="fb-like" style="margin-top:4px; margin-left:5px;" data-href="http://geekies.co/maybelline/pc.php?url=<?php echo $_REQUEST["url"];?>" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>
