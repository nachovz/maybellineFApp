...
<meta property="og:url" content="http://geekies.co/maybelline/redes.php" />
...
<div class="container">
       ...
       <div class="cellimagen1" onClick="javascript: self.location='pc.php?url=<?php echo $_REQUEST["url"];?>&name=<?php echo $_REQUEST["name"] ?>&fecha=<?php echo $_REQUEST["fecha"] ?>'">
        <div class="s-cellimagen111"><img src="imagen/compu_1.png" width="110" height="51" class="menu" hover="imagen/compu_11.png"></div>
        </div>
       ...
       <div class="cellimagen3" onClick="javascript: self.location='redes.php?url=<?php echo $_REQUEST["url"];?>&name=<?php echo $_REQUEST["name"] ?>&fecha=<?php echo $_REQUEST["fecha"] ?>'">
        <div class="s-cellimagen3"><img src="imagen/redes_11.png" width="101" height="50" class="menu" hover="imagen/redes_11.png"></div>
        </div>
        
       <div class="fuentes2 botonr" onClick="javascript: self.location='galeria.html'"></div>
      <div class="conredes"><img src="imagen/fullredes.png" width="764" height="736"></div>


            <div class="menucell">
            <div><img src="imagen/descarga.png" width="83" height="15"></div>
            <ul class="s-menucell">
            <li><img src="imagen/Facebook.png" width="177" height="73" class="menu" hover="imagen/Facebook1.png" onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=Facebook.jpeg'"></li>
            <li class="s-menucell1"><img src="imagen/Twittercopia.png" width="177" height="72" hover="imagen/Twitter1copia.png" class="menu" onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=Twitter.png'"></li>
            <li class="s-menucell1"><img src="imagen/Pinterestc.png" width="177" height="72" hover="imagen/Pinterest1c.png" class="menu" onClick="javascript: self.location='App Calendario(Maybelline)/<?php echo $_REQUEST["fecha"];?> Alta/descarga.php?name=Pinterestc.jpg'"></li>
            </ul>
         	<div class="SocialDiv">
<div class="fb-like" style="margin-top:4px; margin-left:5px;" data-href="http://geekies.co/maybelline/redes.php" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>
<a name="fb_share" type="button" href="https://www.facebook.com/dialog/feed?
  ...
  picture=http://geekies.co/maybelline/App%20Calendario(Maybelline)/2011%20Alta/Facebook.jpeg&
...
<a href="https://twitter.com/share" class="twitter-share-button link" data-url="#" data-text="Personaliza tu cel, compu o perfiles de redes sociales con las im&aacute;genes del calendario de Maybelline New York. #ILoveMaybelline" data-lang="es" data-related="ILoveMaybelline" data-count="none">Twittear</a>
